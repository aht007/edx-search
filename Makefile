...
upgrade: ## update the requirements/*.txt files with the latest packages satisfying requirements/*.in
	...
	pip-compile --rebuild -o requirements/base.txt requirements/base.in
	pip-compile --rebuild -o requirements/testing.txt requirements/testing.in
	pip-compile --rebuild -o requirements/quality.txt requirements/quality.in
	pip-compile --rebuild -o requirements/ci.txt requirements/ci.in
	pip-compile --rebuild -o requirements/dev.txt requirements/dev.in
